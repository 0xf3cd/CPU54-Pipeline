...
//     wire rs_id_conf = (id_rf_we && id_rf_waddr == rs && id_rf_waddr != 5'b0);
//     wire rt_id_conf = (id_rf_we && id_rf_waddr == rs && id_rf_waddr != 5'b0);
...
// 	wire conf = (rs_exe_conf || rt_exe_conf || rs_mem_conf || rt_mem_conf || rs_id_conf || rt_id_conf);
// 	wire rs_conf = (rs_exe_conf || rs_mem_conf || rs_id_conf);
