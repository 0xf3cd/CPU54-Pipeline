...
write_SD_buffer:
sw $2, 0x4008($10) # buffer data
sw $4, 0x4000($10) # buffer addr
sw $6, 0x4004($10) # write ena
sw $0, 0x4004($10)
addi $2, $2, 1
addi $4, $4, 1
bne $4, $5, write_SD_buffer
# write buffer end

addi $2, $0, 1
addi $3, $0, 2
sw $2, 0x400C($10) # SD write addr
sw $3, 0x4010($10) # start SD write
check_SD_write_status:
lw $4, 0x4014($10)
and $4, $4, $3
bne $4, $0, check_SD_write_status
